...
public abstract class AbstractBoard extends JPanel {
    ...
    // Métodos abstratos que cada jogo (filho) deve implementar
    ...
    public AbstractBoard() {
        // O construtor agora só prepara o básico do painel (JPanel).
        initBoard();
    }
    ...
    // EVOLUÇÃO: Este método é chamado automaticamente pelo Swing quando o painel está pronto para ser exibido.
    // É o lugar perfeito e seguro para iniciar o jogo.
    @Override
    ...
    // EVOLUÇÃO: Toda a lógica de inicialização do jogo foi movida para cá.
    // Ele só é chamado quando o objeto AbstractBoard e suas subclasses já estão 100% construídos.
